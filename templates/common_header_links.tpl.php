					...
					<div id="uws-quick-links-grp-container">
						<div class="grid_4 alpha">
							<span class="h4">Governance</span>
 							<ul class="ul__reset">
								...
								<li>
									<a href="http://www.uws.edu.au/mtd/strategy_and_planning">
										Strategy and Planning
									</a>
								</li>
								<li>
									<a href="http://www.uws.edu.au/policy/policy_dds">
										Policies
									</a>
								</li>
								<li>
									<a href="http://www.uws.edu.au/strategy_and_quality/sg">
										Quality Management
									</a>
								</li>
								<li>
						...
						<div class="grid_4">
							...
							<ul class="ul__reset">
								...
								<li>
									<a href="http://www.uws.edu.au/staff_profiles">
										Staff Profiles
									</a>
								</li>
								<li>
									<a href="https://staffonline.uws.edu.au/">
										Staff Online
									</a>
								</li>
								<li>
									<a href="http://careers.uws.edu.au/">
										Employment at UWS
									</a>
								</li>
								<li>
						...
						<div class="grid_4">
							...
							<ul class="ul__reset">
								...
								<li>
									<a href="http://www.uws.edu.au/currentstudents/current_students/starting_out">
										Accept and Enrol
									</a>
								</li>
								<li>
								...
								<li>
									<a href="http://www.uws.edu.au/currentstudents/current_students/managing_your_study/forms">
										Student Forms
									</a>
								</li>
								<li>
						...
						<div class="grid_4">
							...
							<ul class="ul__reset">
								...
								<li>
									<a href="http://handbook.uws.edu.au/hbook/">
										Handbook
									</a>
								</li>
								<li>
									<a href="http://www.uws.edu.au/informationabout/scholarships_home">
										Scholarships
									</a>
								</li>
								<li>
									<a href="http://www.uws.edu.au/currentstudents/current_students/managing_your_study/enrolment/tutorial_registration">
						...
						<div class="grid_4">
							...
							<ul class="ul__reset">
								<li>
									<a href="https://myuwsaccount.uws.edu.au/">
										Password Management
									</a>
								</li>
								<li>
									<a href="http://www.uws.edu.au/information_technology_services/its/airuws_lite">
										Air UWS - Wireless
									</a>
								</li>
								<li>
									<a href="http://connectbooks.com.au/">
										UWSConnect Books
									</a>
								</li>
								<li>
									<a href="http://future.uws.edu.au/future_students_home/studentlife/accommodation">
										Accommodation
									</a>
								</li>
								<li>
									<a href="http://www.uws.edu.au/information_technology_services/its">
										IT Services
									</a>
								</li>
							</ul>
						...
						<div class="grid_4 omega">
							...
							<ul class="ul__reset">
								<li>
									<a href="http://www.uwscollege.edu.au/">
										UWSCollege
									</a>
								</li>
								<li>
									<a href="http://www.whitlam.org/">
										Whitlam Institute
									</a>
								</li>
								<li>
									<a href="http://www.tvs.org.au/">
										TVS
									</a>
								</li>
								<li>
									<a href="http://www.uwsconnect.com.au/">
										UWSconnect
									</a>
								</li>
								<li>
									<a id="header-quickLinks-last" href="http://www.smexcellence.com.au/sme/index.php">
										SMExcellence
									</a>
								</li>
							</ul>
